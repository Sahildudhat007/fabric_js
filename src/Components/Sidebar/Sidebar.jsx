...
function Sidebar({ onAddSquare, onAddRectangle, onAddTriangle, onAddCircle, onAddPentagon, onAddHexagon, onAddRoundedOctagon, onAddDiamondStar, onAddStar, onAddLine, onAddText, onUploadImage, onChangeColor, onChangeSize, onActivatePenTool, }) {
